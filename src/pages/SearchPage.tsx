                    ...
                    item?.id?.kind !== 'youtube#channel' && item?.id?.kind !== 'youtube#playlist' ? (
                        <Link to={`/watch?v=${item.id.videoId || item.id.playlistId}`} key={index}>
                            <div className="flex gap-5 540res:gap-3">
                                ...
                                <div className="w-[75%] flex flex-col gap-[.5vw]">
                                    <h3 className="text-[1vw] 1900res:text-[1.3vw] 1580res:text-[1.5vw] 1000res:text-[2vw] font-[550] text-white">{item.snippet.title}</h3>
                                    <div className='text-[.8vw] 1900res:text-[1vw] 1580res:text-[1.2vw] 1000res:text-[1.8vw] flex flex-col gap-[.3vw]'>
                        ...
                        <Link to={`/channels/${item.id.channelId}`} key={index}>
                            <div className="flex gap-5 540res:gap-3">
                                ...
                                <div className="flex flex-col gap-[.4vw] text-[#aaaaaa] w-[75%] mt-2 text-[.8vw] 1900res:text-[1vw] 1580res:text-[1.2vw] 1000res:text-[1.8vw]">
