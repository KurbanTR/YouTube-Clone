...
const CardVideo: React.FC<{item?: VideoItemType; type: string; isLoad?: boolean; index?: number}> = ({ item, type, isLoad, index }) => {
    ...
    const videoData = vId ? videoTimes?.[vId] : null;
    ...
    const handleMouseEnter = (videoId?: string) => {
        if (window.innerWidth >= 540 && videoId) setActiveVideoId(videoId);
    };
        ...
        >
            <Link to={type === 'video' ? `/watch?v=${videoId}&t=${time}s` : `playlist?list=${playlistId}`}>
                ...
                <div className='px-[.2vw] 2230res:px-[.3vw] 1900res:px-[.4vw] 1580res:px-[.5vw] 1000res:px-[.6vw] 500res:px-[2vw] pt-[.3vw] 2230res:pt-[.4vw] 1900res:pt-[.5vw] 1580res:pt-[.6vw] 1000res:pt-[.7vw] 500res:pt-[1vw]'>                    
                    ...
                    <div className="text-[.3vw] 2230res:text-[.5vw] 1900res:text-[.7vw] 1580res:text-[.9vw] 1000res:text-[1.1vw] 500res:text-[2vw] pt-[.1vw] 2230res:pt-[.2vw] 1900res:pt-[.3vw] 1580res:pt-[.4vw] 1000res:pt-[.5vw] flex">
